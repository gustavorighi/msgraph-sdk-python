...
if TYPE_CHECKING:
    from ....models.entitlement_management_settings import EntitlementManagementSettings
...
class SettingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/settings{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SettingsRequestBuilderGetQueryParameters]] = None) -> Optional[EntitlementManagementSettings]:
        """
        ...
        return await self.request_adapter.send_async(request_info, EntitlementManagementSettings, error_mapping)
    
    async def patch(self,body: EntitlementManagementSettings, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EntitlementManagementSettings]:
        """
    ...
    def to_patch_request_information(self,body: EntitlementManagementSettings, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update an existing entitlementManagementSettings object to change one or more of its properties.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
