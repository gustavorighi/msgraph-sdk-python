...
class AppConsentRequestsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AppConsentRequestsRequestBuilderGetQueryParameters]] = None) -> Optional[AppConsentRequestCollectionResponse]:
        """
    ...
    async def post(self,body: AppConsentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AppConsentRequest]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AppConsentRequestsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve appConsentRequest objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: AppConsentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to appConsentRequests for identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AppConsentRequestsRequestBuilder:
        """
    ...
    @dataclass
    class AppConsentRequestsRequestBuilderGetRequestConfiguration(RequestConfiguration[AppConsentRequestsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AppConsentRequestsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
