...
class AcceptancesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AcceptancesRequestBuilderGetQueryParameters]] = None) -> Optional[AgreementAcceptanceCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AcceptancesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the details about the acceptance records for a specific agreement.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AcceptancesRequestBuilder:
        """
    ...
    @dataclass
    class AcceptancesRequestBuilderGetRequestConfiguration(RequestConfiguration[AcceptancesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AcceptancesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
