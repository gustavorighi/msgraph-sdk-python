...
class EligibilityScheduleRequestsRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[EligibilityScheduleRequestsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the privilegedAccessGroupEligibilityScheduleRequest objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: PrivilegedAccessGroupEligibilityScheduleRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new privilegedAccessGroupEligibilityScheduleRequest object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> EligibilityScheduleRequestsRequestBuilder:
        """
    ...
    @dataclass
    class EligibilityScheduleRequestsRequestBuilderGetRequestConfiguration(RequestConfiguration[EligibilityScheduleRequestsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class EligibilityScheduleRequestsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
