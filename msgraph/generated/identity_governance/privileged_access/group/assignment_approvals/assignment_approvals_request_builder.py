...
class AssignmentApprovalsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AssignmentApprovalsRequestBuilderGetQueryParameters]] = None) -> Optional[ApprovalCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AssignmentApprovalsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get assignmentApprovals from identityGovernance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AssignmentApprovalsRequestBuilder:
        """
        ...
        return AssignmentApprovalsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class AssignmentApprovalsRequestBuilderGetRequestConfiguration(RequestConfiguration[AssignmentApprovalsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AssignmentApprovalsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
