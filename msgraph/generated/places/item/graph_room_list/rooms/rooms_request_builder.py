...
if TYPE_CHECKING:
    ...
    from .item.room_item_request_builder import RoomItemRequestBuilder
...
class RoomsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/{place%2Did}/graph.roomList/rooms{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_room_id(self,room_id: str) -> RoomItemRequestBuilder:
        """
        Provides operations to manage the rooms property of the microsoft.graph.roomList entity.
        param room_id: The unique identifier of room
        Returns: RoomItemRequestBuilder
        """
        if not room_id:
            raise TypeError("room_id cannot be null.")
        from .item.room_item_request_builder import RoomItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["room%2Did"] = room_id
        return RoomItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RoomsRequestBuilderGetQueryParameters]] = None) -> Optional[RoomCollectionResponse]:
        """
    ...
    async def post(self,body: Room, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Room]:
        """
    ...
    def to_post_request_information(self,body: Room, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to rooms for places
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
