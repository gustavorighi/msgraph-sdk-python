...
class UnsetVerifiedPublisherRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> UnsetVerifiedPublisherRequestBuilder:
        """
    ...
    @dataclass
    class UnsetVerifiedPublisherRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
