...
class OrganizationRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Organization, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Organization]:
        """
    ...
    def to_post_request_information(self,body: Organization, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Add new entity to organization
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class OrganizationRequestBuilderGetRequestConfiguration(RequestConfiguration[OrganizationRequestBuilderGetQueryParameters]):
        """
