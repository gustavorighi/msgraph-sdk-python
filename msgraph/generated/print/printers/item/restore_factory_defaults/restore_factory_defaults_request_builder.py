...
class RestoreFactoryDefaultsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/print/printers/{printer%2Did}/restoreFactoryDefaults", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RestoreFactoryDefaultsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RestoreFactoryDefaultsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return RestoreFactoryDefaultsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RestoreFactoryDefaultsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
