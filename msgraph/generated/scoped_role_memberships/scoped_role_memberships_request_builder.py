...
class ScopedRoleMembershipsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/scopedRoleMemberships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ScopedRoleMembershipsRequestBuilderGetQueryParameters]] = None) -> Optional[ScopedRoleMembershipCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ScopedRoleMembershipsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get entities from scopedRoleMemberships
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ScopedRoleMembershipsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ScopedRoleMembershipsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ScopedRoleMembershipsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ScopedRoleMembershipsRequestBuilderGetRequestConfiguration(RequestConfiguration[ScopedRoleMembershipsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ScopedRoleMembershipsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
