...
class HistoryRequestBuilder(BaseRequestBuilder):
    ...
    def by_risky_service_principal_history_item_id(self,risky_service_principal_history_item_id: str) -> RiskyServicePrincipalHistoryItemItemRequestBuilder:
        """
        Provides operations to manage the history property of the microsoft.graph.riskyServicePrincipal entity.
        param risky_service_principal_history_item_id: The unique identifier of riskyServicePrincipalHistoryItem
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[HistoryRequestBuilderGetQueryParameters]] = None) -> Optional[RiskyServicePrincipalHistoryItemCollectionResponse]:
        """
    ...
    async def post(self,body: RiskyServicePrincipalHistoryItem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RiskyServicePrincipalHistoryItem]:
        """
    ...
    def to_post_request_information(self,body: RiskyServicePrincipalHistoryItem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to history for identityProtection
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
