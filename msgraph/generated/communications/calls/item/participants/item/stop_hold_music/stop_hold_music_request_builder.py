...
class StopHoldMusicRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: StopHoldMusicPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[StopHoldMusicOperation]:
        """
    ...
    def to_post_request_information(self,body: StopHoldMusicPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Reincorporate a participant previously put on hold to the call.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> StopHoldMusicRequestBuilder:
        """
    ...
    @dataclass
    class StopHoldMusicRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
