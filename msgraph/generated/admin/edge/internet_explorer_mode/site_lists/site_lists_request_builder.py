...
class SiteListsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_browser_site_list_id(self,browser_site_list_id: str) -> BrowserSiteListItemRequestBuilder:
        """
        Provides operations to manage the siteLists property of the microsoft.graph.internetExplorerMode entity.
        param browser_site_list_id: The unique identifier of browserSiteList
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SiteListsRequestBuilderGetQueryParameters]] = None) -> Optional[BrowserSiteListCollectionResponse]:
        """
    ...
    async def post(self,body: BrowserSiteList, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BrowserSiteList]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SiteListsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the browserSiteList objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: BrowserSiteList, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new browserSiteList object to support Internet Explorer mode.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SiteListsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SiteListsRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class SiteListsRequestBuilderGetRequestConfiguration(RequestConfiguration[SiteListsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class SiteListsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
