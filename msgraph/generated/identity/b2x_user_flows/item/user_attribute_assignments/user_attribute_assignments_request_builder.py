...
class UserAttributeAssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userAttributeAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UserAttributeAssignmentsRequestBuilderGetQueryParameters]] = None) -> Optional[IdentityUserFlowAttributeAssignmentCollectionResponse]:
        """
    ...
    async def post(self,body: IdentityUserFlowAttributeAssignment, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[IdentityUserFlowAttributeAssignment]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserAttributeAssignmentsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the identityUserFlowAttributeAssignment resources from the userAttributeAssignments navigation property in a b2xIdentityUserFlow.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: IdentityUserFlowAttributeAssignment, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new identityUserFlowAttributeAssignment object in a b2xIdentityUserFlow.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserAttributeAssignmentsRequestBuilder:
        """
    ...
    @dataclass
    class UserAttributeAssignmentsRequestBuilderGetRequestConfiguration(RequestConfiguration[UserAttributeAssignmentsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UserAttributeAssignmentsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
