...
class CustomAuthenticationExtensionItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> CustomAuthenticationExtensionItemRequestBuilder:
        """
    ...
    @dataclass
    class CustomAuthenticationExtensionItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CustomAuthenticationExtensionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[CustomAuthenticationExtensionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class CustomAuthenticationExtensionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
