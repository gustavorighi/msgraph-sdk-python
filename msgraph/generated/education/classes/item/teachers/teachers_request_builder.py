...
class TeachersRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/teachers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TeachersRequestBuilderGetQueryParameters]] = None) -> Optional[EducationUserCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TeachersRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve a list of teachers for a class. Delegated tokens must be members of the class to get the teacher list.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> TeachersRequestBuilder:
        """
    ...
    @dataclass
    class TeachersRequestBuilderGetRequestConfiguration(RequestConfiguration[TeachersRequestBuilderGetQueryParameters]):
        """
