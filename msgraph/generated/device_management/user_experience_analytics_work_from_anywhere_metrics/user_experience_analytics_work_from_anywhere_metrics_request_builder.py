...
class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetQueryParameters]] = None) -> Optional[UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse]:
        """
    ...
    async def post(self,body: UserExperienceAnalyticsWorkFromAnywhereMetric, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserExperienceAnalyticsWorkFromAnywhereMetric]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        User experience analytics work from anywhere metrics.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: UserExperienceAnalyticsWorkFromAnywhereMetric, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsWorkFromAnywhereMetrics for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetRequestConfiguration(RequestConfiguration[UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
