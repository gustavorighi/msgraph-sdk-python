...
class UserExperienceAnalyticsMetricHistoryRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsMetricHistoryRequestBuilderGetQueryParameters]] = None) -> Optional[UserExperienceAnalyticsMetricHistoryCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsMetricHistoryRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        User experience analytics metric history
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserExperienceAnalyticsMetricHistoryRequestBuilder:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsMetricHistoryRequestBuilderGetRequestConfiguration(RequestConfiguration[UserExperienceAnalyticsMetricHistoryRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UserExperienceAnalyticsMetricHistoryRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
