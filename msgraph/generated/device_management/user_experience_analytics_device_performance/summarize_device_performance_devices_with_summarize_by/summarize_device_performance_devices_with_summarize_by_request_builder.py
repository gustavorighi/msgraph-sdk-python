...
class SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder:
        """
    ...
    @dataclass
    class SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilderGetRequestConfiguration(RequestConfiguration[SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilderGetQueryParameters]):
        """
