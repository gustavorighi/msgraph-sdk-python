...
class ResourcePerformanceMetricsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ResourcePerformanceMetricsRequestBuilderGetQueryParameters]] = None) -> Optional[UserExperienceAnalyticsCategory]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ResourcePerformanceMetricsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The scores and insights for the resource performance metrics.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ResourcePerformanceMetricsRequestBuilder:
        """
    ...
    @dataclass
    class ResourcePerformanceMetricsRequestBuilderGetRequestConfiguration(RequestConfiguration[ResourcePerformanceMetricsRequestBuilderGetQueryParameters]):
        """
