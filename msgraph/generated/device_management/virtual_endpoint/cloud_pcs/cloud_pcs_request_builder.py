...
if TYPE_CHECKING:
    from ....models.cloud_pc import CloudPC
    from ....models.cloud_pccollection_response import CloudPCCollectionResponse
    from ....models.odata_errors.odata_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.cloud_pcitem_request_builder import CloudPCItemRequestBuilder
...
class CloudPCsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_cloud_pcid(self,cloud_pcid: str) -> CloudPCItemRequestBuilder:
        """
        Provides operations to manage the cloudPCs property of the microsoft.graph.virtualEndpoint entity.
        param cloud_pcid: The unique identifier of cloudPC
        Returns: CloudPCItemRequestBuilder
        """
        if not cloud_pcid:
            raise TypeError("cloud_pcid cannot be null.")
        from .item.cloud_pcitem_request_builder import CloudPCItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["cloudPC%2Did"] = cloud_pcid
