...
if TYPE_CHECKING:
    ...
    from .user_experience_analytics_app_health_application_performance_by_osversion.user_experience_analytics_app_health_application_performance_by_osversion_request_builder import UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder
    ...
    from .user_experience_analytics_app_health_osversion_performance.user_experience_analytics_app_health_osversion_performance_request_builder import UserExperienceAnalyticsAppHealthOSVersionPerformanceRequestBuilder
...
class DeviceManagementRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def user_experience_analytics_app_health_application_performance_by_osversion(self) -> UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionRequestBuilder:
        """
    ...
    @property
    def user_experience_analytics_app_health_osversion_performance(self) -> UserExperienceAnalyticsAppHealthOSVersionPerformanceRequestBuilder:
        """
