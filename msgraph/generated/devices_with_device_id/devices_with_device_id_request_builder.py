...
class DevicesWithDeviceIdRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DevicesWithDeviceIdRequestBuilderGetQueryParameters]] = None) -> Optional[Device]:
        """
    ...
    def with_url(self,raw_url: str) -> DevicesWithDeviceIdRequestBuilder:
        """
    ...
    @dataclass
    class DevicesWithDeviceIdRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class DevicesWithDeviceIdRequestBuilderGetRequestConfiguration(RequestConfiguration[DevicesWithDeviceIdRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DevicesWithDeviceIdRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
