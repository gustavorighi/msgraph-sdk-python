...
class MultiTenantOrganizationMemberItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember%2Did}{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MultiTenantOrganizationMemberItemRequestBuilderGetQueryParameters]] = None) -> Optional[MultiTenantOrganizationMember]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MultiTenantOrganizationMemberItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a tenant and its properties in the multitenant organization.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def with_url(self,raw_url: str) -> MultiTenantOrganizationMemberItemRequestBuilder:
        """
    ...
    @dataclass
    class MultiTenantOrganizationMemberItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class MultiTenantOrganizationMemberItemRequestBuilderGetRequestConfiguration(RequestConfiguration[MultiTenantOrganizationMemberItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class MultiTenantOrganizationMemberItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
