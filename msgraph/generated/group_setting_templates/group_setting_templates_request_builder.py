...
if TYPE_CHECKING:
    ...
    from ..models.group_setting_template_collection_response import GroupSettingTemplateCollectionResponse
...
class GroupSettingTemplatesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/groupSettingTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_group_setting_template_id(self,group_setting_template_id: str) -> GroupSettingTemplateItemRequestBuilder:
        """
        Provides operations to manage the collection of groupSettingTemplate entities.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GroupSettingTemplatesRequestBuilderGetQueryParameters]] = None) -> Optional[GroupSettingTemplateCollectionResponse]:
        """
        ...
        Returns: Optional[GroupSettingTemplateCollectionResponse]
    ...
    async def post(self,body: GroupSettingTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GroupSettingTemplate]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GroupSettingTemplatesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Group setting templates represents a set of templates from which group settings may be created and used within a tenant. This operation retrieves the list of available groupSettingTemplates objects.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: GroupSettingTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Add new entity to groupSettingTemplates
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GroupSettingTemplatesRequestBuilder:
        """
    ...
    @dataclass
    class GroupSettingTemplatesRequestBuilderGetRequestConfiguration(RequestConfiguration[GroupSettingTemplatesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class GroupSettingTemplatesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
