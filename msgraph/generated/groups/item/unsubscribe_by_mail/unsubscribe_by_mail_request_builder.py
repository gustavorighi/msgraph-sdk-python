...
class UnsubscribeByMailRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> UnsubscribeByMailRequestBuilder:
        """
    ...
    @dataclass
    class UnsubscribeByMailRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
