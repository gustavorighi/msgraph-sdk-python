...
class MembersWithLicenseErrorsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MembersWithLicenseErrorsRequestBuilderGetQueryParameters]] = None) -> Optional[DirectoryObjectCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MembersWithLicenseErrorsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        A list of group members with license errors from this group-based license assignment. Read-only.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MembersWithLicenseErrorsRequestBuilder:
        """
    ...
    @dataclass
    class MembersWithLicenseErrorsRequestBuilderGetRequestConfiguration(RequestConfiguration[MembersWithLicenseErrorsRequestBuilderGetQueryParameters]):
        """
