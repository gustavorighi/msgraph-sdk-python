...
class DeviceLocalCredentialsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/deviceLocalCredentials{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DeviceLocalCredentialsRequestBuilderGetQueryParameters]] = None) -> Optional[DeviceLocalCredentialInfoCollectionResponse]:
        """
    ...
    async def post(self,body: DeviceLocalCredentialInfo, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeviceLocalCredentialInfo]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DeviceLocalCredentialsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the deviceLocalCredentialInfo objects and their properties, excluding the credentials property. 
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: DeviceLocalCredentialInfo, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to deviceLocalCredentials for directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> DeviceLocalCredentialsRequestBuilder:
        """
    ...
    @dataclass
    class DeviceLocalCredentialsRequestBuilderGetRequestConfiguration(RequestConfiguration[DeviceLocalCredentialsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class DeviceLocalCredentialsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
