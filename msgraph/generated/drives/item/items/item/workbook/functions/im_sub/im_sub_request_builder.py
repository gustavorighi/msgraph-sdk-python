...
class ImSubRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ImSubPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WorkbookFunctionResult]:
        """
        Invoke action imSub
    ...
    def to_post_request_information(self,body: ImSubPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action imSub
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ImSubRequestBuilder:
        """
    ...
    @dataclass
    class ImSubRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
