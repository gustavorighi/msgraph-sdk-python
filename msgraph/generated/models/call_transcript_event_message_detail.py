...
class CallTranscriptEventMessageDetail(EventMessageDetail):
    ...
    call_transcript_ical_uid: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "callTranscriptICalUid": lambda n : setattr(self, 'call_transcript_ical_uid', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("callTranscriptICalUid", self.call_transcript_ical_uid)
