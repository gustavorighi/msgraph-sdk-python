...
if TYPE_CHECKING:
    ...
    from .io_tdevice_importance_type import IoTDeviceImportanceType
...
class IoTDeviceEvidence(AlertEvidence):
    ...
    # The ioTHub property
    io_thub: Optional[AzureResourceEvidence] = None
    # The ioTSecurityAgentId property
    io_tsecurity_agent_id: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "ioTHub": lambda n : setattr(self, 'io_thub', n.get_object_value(AzureResourceEvidence)),
            "ioTSecurityAgentId": lambda n : setattr(self, 'io_tsecurity_agent_id', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("ioTHub", self.io_thub)
        writer.write_str_value("ioTSecurityAgentId", self.io_tsecurity_agent_id)
