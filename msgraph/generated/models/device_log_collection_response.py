...
class DeviceLogCollectionResponse(Entity):
    ...
    expiration_date_time_utc: Optional[datetime.datetime] = None
    ...
    received_date_time_utc: Optional[datetime.datetime] = None
    # The DateTime of the request.
    requested_date_time_utc: Optional[datetime.datetime] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "expirationDateTimeUTC": lambda n : setattr(self, 'expiration_date_time_utc', n.get_datetime_value()),
            ...
            "receivedDateTimeUTC": lambda n : setattr(self, 'received_date_time_utc', n.get_datetime_value()),
            "requestedDateTimeUTC": lambda n : setattr(self, 'requested_date_time_utc', n.get_datetime_value()),
            "sizeInKB": lambda n : setattr(self, 'size_in_kb', n.get_float_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("expirationDateTimeUTC", self.expiration_date_time_utc)
        ...
        writer.write_datetime_value("receivedDateTimeUTC", self.received_date_time_utc)
        writer.write_datetime_value("requestedDateTimeUTC", self.requested_date_time_utc)
        writer.write_float_value("sizeInKB", self.size_in_kb)
