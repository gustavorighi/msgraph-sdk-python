...
class Fido2CombinationConfiguration(AuthenticationCombinationConfiguration):
    ...
    allowed_aaguids: Optional[List[str]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "allowedAAGUIDs": lambda n : setattr(self, 'allowed_aaguids', n.get_collection_of_primitive_values(str)),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_primitive_values("allowedAAGUIDs", self.allowed_aaguids)
