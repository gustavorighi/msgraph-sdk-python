...
class MicrosoftGraphSecurityExportRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityExportRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphSecurityExportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
