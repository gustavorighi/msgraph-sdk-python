...
class IntelligenceProfileIndicatorsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters]] = None) -> Optional[IntelligenceProfileIndicatorCollectionResponse]:
        """
    ...
    async def post(self,body: IntelligenceProfileIndicator, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[IntelligenceProfileIndicator]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read the properties and relationships of a intelligenceProfileIndicator object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: IntelligenceProfileIndicator, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to intelligenceProfileIndicators for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> IntelligenceProfileIndicatorsRequestBuilder:
        """
    ...
    @dataclass
    class IntelligenceProfileIndicatorsRequestBuilderGetRequestConfiguration(RequestConfiguration[IntelligenceProfileIndicatorsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class IntelligenceProfileIndicatorsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
