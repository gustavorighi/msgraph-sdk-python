...
class RelatedHostsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/sslCertificates/{sslCertificate%2Did}/relatedHosts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RelatedHostsRequestBuilder:
        """
    ...
    @dataclass
    class RelatedHostsRequestBuilderGetRequestConfiguration(RequestConfiguration[RelatedHostsRequestBuilderGetQueryParameters]):
        """
