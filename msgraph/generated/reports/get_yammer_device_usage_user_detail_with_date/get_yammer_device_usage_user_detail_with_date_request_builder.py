...
class GetYammerDeviceUsageUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetYammerDeviceUsageUserDetailWithDateRequestBuilder:
        """
        ...
        return GetYammerDeviceUsageUserDetailWithDateRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
