...
class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder:
        """
        ...
        return GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
