...
class GetTeamsTeamActivityDetailWithDateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetTeamsTeamActivityDetailWithDateRequestBuilder:
        """
        ...
        return GetTeamsTeamActivityDetailWithDateRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class GetTeamsTeamActivityDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
