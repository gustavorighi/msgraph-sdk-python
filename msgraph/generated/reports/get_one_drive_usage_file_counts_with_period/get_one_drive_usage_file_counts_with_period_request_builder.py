...
class GetOneDriveUsageFileCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetOneDriveUsageFileCountsWithPeriodRequestBuilder:
        """
        ...
        return GetOneDriveUsageFileCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class GetOneDriveUsageFileCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
