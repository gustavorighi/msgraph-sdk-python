...
class GetEmailActivityUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetEmailActivityUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
