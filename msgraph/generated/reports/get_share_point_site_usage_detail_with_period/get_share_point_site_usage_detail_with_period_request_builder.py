...
class GetSharePointSiteUsageDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetSharePointSiteUsageDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointSiteUsageDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
