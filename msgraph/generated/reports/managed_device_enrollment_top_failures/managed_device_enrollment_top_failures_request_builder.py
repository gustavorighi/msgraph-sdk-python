...
class ManagedDeviceEnrollmentTopFailuresRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ManagedDeviceEnrollmentTopFailuresRequestBuilder:
        """
    ...
    @dataclass
    class ManagedDeviceEnrollmentTopFailuresRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
