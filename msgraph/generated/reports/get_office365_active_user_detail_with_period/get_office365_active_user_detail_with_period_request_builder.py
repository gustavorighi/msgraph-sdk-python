...
class GetOffice365ActiveUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], period: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(period='{period}')", path_parameters)
    ...
    @dataclass
    class GetOffice365ActiveUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
