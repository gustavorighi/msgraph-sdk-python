...
class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder:
        """
        ...
        return ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
