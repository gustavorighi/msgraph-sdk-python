...
class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], period: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getOffice365GroupsActivityStorage(period='{period}')", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetOffice365GroupsActivityStorageWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
