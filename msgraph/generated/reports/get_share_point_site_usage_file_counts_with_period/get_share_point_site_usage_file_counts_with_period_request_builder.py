...
class GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder:
        """
        ...
        return GetSharePointSiteUsageFileCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class GetSharePointSiteUsageFileCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
