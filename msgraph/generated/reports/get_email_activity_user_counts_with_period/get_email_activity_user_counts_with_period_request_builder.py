...
class GetEmailActivityUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetEmailActivityUserCountsWithPeriodRequestBuilder:
        """
        ...
        return GetEmailActivityUserCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class GetEmailActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
