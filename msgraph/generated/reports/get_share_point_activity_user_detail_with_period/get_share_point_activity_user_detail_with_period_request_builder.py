...
class GetSharePointActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointActivityUserDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
