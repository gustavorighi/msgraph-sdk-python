...
class DomainNameReferencesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/domains/{domain%2Did}/domainNameReferences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DomainNameReferencesRequestBuilderGetQueryParameters]] = None) -> Optional[DirectoryObjectCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DomainNameReferencesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve a list of directoryObject with a reference to the domain. The returned list will contain all directory objects that have a dependency on the domain.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> DomainNameReferencesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DomainNameReferencesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return DomainNameReferencesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class DomainNameReferencesRequestBuilderGetRequestConfiguration(RequestConfiguration[DomainNameReferencesRequestBuilderGetQueryParameters]):
        """
