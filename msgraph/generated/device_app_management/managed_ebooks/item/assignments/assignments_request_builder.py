...
if TYPE_CHECKING:
    from .....models.managed_ebook_assignment import ManagedEBookAssignment
    from .....models.managed_ebook_assignment_collection_response import ManagedEBookAssignmentCollectionResponse
    from .....models.odata_errors.odata_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.managed_ebook_assignment_item_request_builder import ManagedEBookAssignmentItemRequestBuilder
...
class AssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_managed_ebook_assignment_id(self,managed_ebook_assignment_id: str) -> ManagedEBookAssignmentItemRequestBuilder:
        """
        Provides operations to manage the assignments property of the microsoft.graph.managedEBook entity.
        param managed_ebook_assignment_id: The unique identifier of managedEBookAssignment
        Returns: ManagedEBookAssignmentItemRequestBuilder
        """
        if not managed_ebook_assignment_id:
            raise TypeError("managed_ebook_assignment_id cannot be null.")
        from .item.managed_ebook_assignment_item_request_builder import ManagedEBookAssignmentItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["managedEBookAssignment%2Did"] = managed_ebook_assignment_id
