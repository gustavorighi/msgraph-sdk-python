...
if TYPE_CHECKING:
    from ...models.managed_ebook import ManagedEBook
    from ...models.managed_ebook_collection_response import ManagedEBookCollectionResponse
    from ...models.odata_errors.odata_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.managed_ebook_item_request_builder import ManagedEBookItemRequestBuilder
...
class ManagedEBooksRequestBuilder(BaseRequestBuilder):
    ...
    def by_managed_ebook_id(self,managed_ebook_id: str) -> ManagedEBookItemRequestBuilder:
        """
        Provides operations to manage the managedEBooks property of the microsoft.graph.deviceAppManagement entity.
        param managed_ebook_id: The unique identifier of managedEBook
        Returns: ManagedEBookItemRequestBuilder
        """
        if not managed_ebook_id:
            raise TypeError("managed_ebook_id cannot be null.")
        from .item.managed_ebook_item_request_builder import ManagedEBookItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["managedEBook%2Did"] = managed_ebook_id
