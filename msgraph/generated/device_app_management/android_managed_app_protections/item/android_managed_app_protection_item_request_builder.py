...
class AndroidManagedAppProtectionItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AndroidManagedAppProtectionItemRequestBuilder:
        """
    ...
    @dataclass
    class AndroidManagedAppProtectionItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class AndroidManagedAppProtectionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[AndroidManagedAppProtectionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class AndroidManagedAppProtectionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
