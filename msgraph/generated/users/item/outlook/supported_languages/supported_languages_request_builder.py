...
class SupportedLanguagesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> SupportedLanguagesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SupportedLanguagesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return SupportedLanguagesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class SupportedLanguagesRequestBuilderGetRequestConfiguration(RequestConfiguration[SupportedLanguagesRequestBuilderGetQueryParameters]):
        """
