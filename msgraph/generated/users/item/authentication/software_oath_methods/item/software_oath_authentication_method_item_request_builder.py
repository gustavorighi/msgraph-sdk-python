...
class SoftwareOathAuthenticationMethodItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> SoftwareOathAuthenticationMethodItemRequestBuilder:
        """
    ...
    @dataclass
    class SoftwareOathAuthenticationMethodItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class SoftwareOathAuthenticationMethodItemRequestBuilderGetRequestConfiguration(RequestConfiguration[SoftwareOathAuthenticationMethodItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
