...
if TYPE_CHECKING:
    ...
    from .item.todo_task_item_request_builder import TodoTaskItemRequestBuilder
...
class TasksRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_todo_task_id(self,todo_task_id: str) -> TodoTaskItemRequestBuilder:
        """
        Provides operations to manage the tasks property of the microsoft.graph.todoTaskList entity.
        param todo_task_id: The unique identifier of todoTask
        Returns: TodoTaskItemRequestBuilder
        """
        if not todo_task_id:
            raise TypeError("todo_task_id cannot be null.")
        from .item.todo_task_item_request_builder import TodoTaskItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["todoTask%2Did"] = todo_task_id
        return TodoTaskItemRequestBuilder(self.request_adapter, url_tpl_params)
